              ...
              {images.map((url, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center gap-3 backdrop-blur-[2px]">
                    ...
                    <button
                      onClick={() => window.open(url, '_blank')}
                      className="w-10 h-10 rounded-full bg-[var(--primary)] hover:brightness-110 text-[var(--primary-foreground)] flex items-center justify-center transition-colors shadow-[0_0_15px_var(--primary)]"
                    >
