...
export function PricingModal({ isOpen, onOpenChange, userEmail, userId }: PricingModalProps) {
  ...
  const plans = [
    ...
    },
    {
      ...
      description: 'Plano 100% personalizado de acordo com a sua necessidade e volume de operação.',
      features: ['Volume ilimitado de tokens', 'Gerente de conta dedicado', 'Integração via API', 'Faturamento via fatura/boleto', 'Suporte prioritário'],
      popular: false,
      isEnterprise: true,
