...
const portals = [
  ...
  },
  {
    ...
    border: 'border-white/5', // Removido o hover ativo
    activeBorder: '',
    accent: '#ffffff',
    accentHover: '',
    badge: 'EM BREVE', // Badge alterado
...
export default function LoginPage() {
  ...
  const handleNicheSelect = (niche: string, isEnabled: boolean) => {
    if (!isEnabled) return; // Impede a seleção de nichos inativos
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {portals.map((portal, index) => {
            ...
            // Lógica de visualização para bloqueados
