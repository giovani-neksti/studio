            ...
            {step === 'email' ? (
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="md3-label-small text-[var(--on-surface-variant)]/50">ou</span>
                  <div className="flex-1 h-px bg-[var(--outline-variant)]/40" />
                </div>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full h-14 rounded-[var(--shape-full)] border border-[var(--outline)]/40 bg-[var(--surface-container-low)] text-[var(--foreground)] md3-label-large flex items-center justify-center gap-3 transition-all duration-[var(--duration-medium2)] ease-[var(--easing-standard)] hover:bg-[var(--surface-container)] hover:elevation-1 active:scale-[0.98] disabled:opacity-[0.38] disabled:cursor-not-allowed"
                >
                ...
                <p className="md3-body-small text-[var(--on-surface-variant)]/60 text-center leading-relaxed">
                  Se você ainda não tem uma conta, criaremos uma automaticamente.
                </p>
              </div>
